...
import image from "../assets/service/bpo.jpg"
const about = [
    { image: image, desc: "We are the leading IT solution company with its inception in 2010, aims to work in the areas of  project/program management and execution in  the varied IT services space, IT-enabled services, specialized domain/vertical-centric resource  augmentation services across India and overseas. ASIANHOPE IT C aims to found another group of companies with diversified services portfolios in the near future." },
    { image: image, desc: "ASIANHOPE IT C management team consists of senior industry experts that have had rich experience in these functional areas for more than 12  years, worked with various renowned global  organizations, and then created the organizational  group in recent times." },
    { image: image, desc: "ASIANHOPE IT C management aims to work in collaborative mode with large system integrators across  the country, and abroad in specialized staffing services, software project plans to take up turnkey projects as system integrators wherein it will do the overall program management through a consortium." },
                ...
                <div className="grid grid-cols-1 gap-5 lg:gap-12 pt-10">
                    {about?.map((item, i) => (
                        <div key={i} className='md:flex gap-10' dir={i % 2 ? "ltr" : "rtl"}>
                            <div className=' md:w-1/2 h-[300px] sm:h-[350px]' >
